...
def show_model_metrics():
    ...
    loss_acc_df = pd.read_csv('exp3/training_metrics_epoch5.csv')
    ...
    confusion_matrix_image = Image.open("exp3/confusion_matrix.png")
    ...
    metrics_plot_image = Image.open("exp3/metrics_plot.png")
